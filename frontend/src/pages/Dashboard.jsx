...
function StatCard({ title, value, subtitle, textClass = "text-white" }) {
  return (
    <div className="bg-[#2b2d31] p-5 rounded-lg border border-[#1e1f22] shadow-sm">
      <h3 className="text-[#99AAB5] text-xs font-bold uppercase tracking-wider mb-2">{title}</h3>
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-8 bg-[#313338]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <StatCard title="Active Teams" value="3" subtitle="Managing 12 members" />
            <StatCard title="Reports Today" value="8" subtitle="4 pending submissions" />
            <StatCard title="Completion Rate" value="85%" subtitle="+5% from last week" textClass="text-green-400" />
          </div>
          ...
          <div className="bg-[#2b2d31] rounded-lg border border-[#1e1f22] p-6">
            ...
            <div className="text-[#99AAB5] text-sm flex items-center justify-center h-32 border-2 border-dashed 
